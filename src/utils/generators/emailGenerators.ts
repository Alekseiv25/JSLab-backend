...
export interface IUserInviteGeneratorArguments {
  invitedUserFirstName: string;
  inviterUserFirstName: string;
  inviterUserLastName: string;
  businessName: string;
  inviteLink: string;
}
...
export function generateHTMLForEmailToInviteUser(
  information: IUserInviteGeneratorArguments,
): string {
  const HTMLForEmail = `
  <html>
    <head></head>
